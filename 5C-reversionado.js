...
$botonCargar.onclick= function(){
    ...
    if (segundosDeLasClases>=segundosPorMinuto){
        ...
        segundosDeLasClases=segundosDeLasClases-(minutosAuxiliar*segundosPorMinuto);
    }
    ...
    document.querySelector('#resultado-tiempo-total').textContent=`El tiempo total de los videos es de ${horasDeLasClases} horas, con ${minutosDeLasClases} minutos y ${segundosDeLasClases} segundos`;
    return false
}
